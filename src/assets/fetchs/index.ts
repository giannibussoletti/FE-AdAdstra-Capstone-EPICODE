...
export const fetchCinemas = async (): Promise<CinemaFetchType[]> => {
  try {
    const res = await fetch(
      "be-adadstra-capstone-epicode-production.up.railway.app:5555/public/cinemas",
    )
...
export const fetchScreenTimes = async (cinemaId: string): Promise<MovieGroup[]> => {
  try {
    const res = await fetch(
      "be-adadstra-capstone-epicode-production.up.railway.app:5555/public/screening-times",
      {
        method: "POST",
        headers: {
...
export const fetchSeats = async (cinemaId: string, screenId: string): Promise<SeatGroup[]> => {
  try {
    const res = await fetch(
      "be-adadstra-capstone-epicode-production.up.railway.app:5555/public/seats",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const fetchBookedSeats = async (screeningTimeId: string): Promise<SeatGroup[]> => {
  try {
    const res = await fetch(
      "be-adadstra-capstone-epicode-production.up.railway.app:5555/public/tickets",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const fetchBooking = async (
  ...
  const publicBooking =
    "be-adadstra-capstone-epicode-production.up.railway.app:5555/public/bookings"
  const noPublic = "be-adadstra-capstone-epicode-production.up.railway.app:5555/bookings"
  try {
...
export const fetchRegistration = async (
  ...
  try {
    const res = await fetch(
      "be-adadstra-capstone-epicode-production.up.railway.app:5555/auth/registration",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const fetchLogin = async (email: string, password: string): Promise<ProfileType> => {
  try {
    const res = await fetch(
      "be-adadstra-capstone-epicode-production.up.railway.app:5555/auth/login",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const fetchMovies = async (): Promise<MovieDetails[]> => {
  try {
    const res = await fetch(
      "be-adadstra-capstone-epicode-production.up.railway.app:5555/public/movies",
    )
...
export const fetchMovieDetails = async (movieId: string): Promise<MovieDetails> => {
  try {
    const res = await fetch(
      "be-adadstra-capstone-epicode-production.up.railway.app:5555/public/movies/" + movieId,
    )
...
export const verifyAccessToken = async (token: string): Promise<void> => {
  try {
    const res = await fetch(
      "be-adadstra-capstone-epicode-production.up.railway.app:5555/auth/token",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const fetchUserMovies = async (): Promise<UserMovies[]> => {
  try {
    const isLogged = localStorage.getItem("accessToken")
    const res = await fetch(
      "be-adadstra-capstone-epicode-production.up.railway.app:5555/tickets/user-movies",
      {
        headers: {
          Authorization: "Bearer " + isLogged,
        },
...
export const fetchUpdatePsw = async (
  ...
  try {
    const isLogged = localStorage.getItem("accessToken")
    const res = await fetch(
      "be-adadstra-capstone-epicode-production.up.railway.app:5555/user/profile/password",
      {
        method: "PATCH",
        headers: {
          Authorization: "Bearer " + isLogged,
...
export const fetchUpdateMail = async (newEmail: string): Promise<UpdateResponse> => {
  try {
    const isLogged = localStorage.getItem("accessToken")
    const res = await fetch(
      "be-adadstra-capstone-epicode-production.up.railway.app:5555/user/profile/new-email",
      {
        method: "PATCH",
        headers: {
          Authorization: "Bearer " + isLogged,
...
export const fetchUpdateProPic = async (image: FileList): Promise<{ imageLink: string }> => {
  try {
    ...
    const res = await fetch(
      "be-adadstra-capstone-epicode-production.up.railway.app:5555/user/profile/avatar",
      {
        method: "PATCH",
        headers: {
          Authorization: "Bearer " + isLogged,
